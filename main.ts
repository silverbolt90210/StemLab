...
namespace StemLab {
    ...
    //% blockId=StemLab_Sensor_Light block="Light|pin %pin"
    //% weight=100
    //% blockGap=20
    //% color="#228B22"
    ...
    //% blockId=Stem_Sensor_Sound block="Sound|pin %pin"
    //% weight=99
    //% blockGap=20
    //% color="#228B22"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=StemLab_Sensor_GetRGBValue block="GetRGBValue|value %value"
    //% blockGap=20
    //% weight=98
    //% color="#228B22"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=StemLab_Sensor_Ultrasonic block="Ultrasonic|Trig %Trig|Echo %Echo"
    //% color="#228B22"
    //% weight=97
    //% blockGap=20
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=StemLab_Sensor_IR block="IR|pin %pin|value %value"
    //% weight=96
    //% blockGap=20
    //% color="#228B22"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=StemLab_Sensor_Vibration block="Vibration|pin %pin|get "
    //% weight=95
    //% blockGap=20
    //% color="#228B22"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=StemLab_Sensor_Hall block="Hall|pin %pin|get "
    //% weight=94
    //% blockGap=20
    //% color="#228B22"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
...
namespace StenLab_Matrix {
    ...
    //% blockId=StemLab_Matrix_LED1 block="LED1|pin %pin|value %value"
    //% weight=5
    //% blockGap=20
    //% color="#C814B8"
    ...
    //% blockId=StemLab_Matrix_LED2 block="LED2|pin %pin|value %value"
    //% weight=4
    //% blockGap=20
    //% color="#C814B8"
    ...
    //% blockId=StemLab_Matrix_BreathLED block="BreathLED|pin %pin"
    //% weight=3
    //% blockGap=20
    //% color="#C814B8"
    ...
    //% blockId=StemLab_Matrix_RGB block="RGB|pin1 %pin1|pin2 %pin2|pin3 %pin3|value1 %value1|value2 %value2|value3 %value3"
    //% weight=2
    //% blockGap=20
    //% color="#C814B8"
    ...
    //% blockId=StemLab_Matrix_RGB2 block="RGB|pin1 %pin1|pin2 %pin2|pin3 %pin3|value %value"
    //% weight=1
    //% blockGap=20
    //% color="#C814B8"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
...
namespace StemLab_Input {
    ...
    //% blockId=StemLab_Input_Potentiometer block="Potentiometer|pin %pin"
    //% weight=100
    //% blockGap=20
    //% color="#808080"
    ...
    //% blockId=StemLab_Input_Rocker block="Rocker|pin1 %pin1|pin2 %pin2|value %value"
    //% weight=99
    //% blockGap=20
    //% color="#808080"
    ...
    //% blockId=StemLab_Input_Button block="Button|pin %pin|value %value"
    //% weight=98
    //% blockGap=20
    //% color="#808080"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
...
namespace StemLab_Motor {

    //% blockId=StemLab_Motor_Servo block="Servo|pin %pin|value %value"
    //% weight=100
    //% blockGap=20
    ...
    //% blockId=StemLab_Motor_MotorStop block="MotorStop |pin %pin"
    //% weight=98
    //% blockGap=20
...
namespace StemLab {
    ...
    //% blockId=StemLab_Play_Music block="Music_Handle|%index"
    //% weight=99
    //% blockGap=20
    //% color="#8FBC8F"
    ...
    //% blockId=StemLab_Music_Handle block="Music_Handle|%index"
    //% weight=98
    //% blockGap=20
    //% color="#8FBC8F"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=StemLab_Touch block="Music Touch return"
    //% weight=97
    //% blockGap=20
    //% color="#8FBC8F"
    ...
    //% blockId=StemLab_TouchButton block="Music Button|%value"
    //% weight=96
    //% blockGap=20
    //% color="#8FBC8F"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=6
    ...
    //% blockId=StemLab_PlayPiano block="Play Piano|tone %value"
    //% weight=95
    //% blockGap=20
    //% color="#8FBC8F"
    ...
    //% blockId=StemLab_KeyBoard_Touch block="KeyBoard Touch Return|value %value"
    //% weight=94
    //% blockGap=20 
    //% color="#8FBC8F"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=StemLab_KeyBoard_SetBaudRate block="KeyBoard SetBaudRate|%baudRate"
    //% weight=93
    //% blockGap=20 
    //% color="#8FBC8F"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=StemLab_KeyBoard block="KeyBoard|%key"
    //% weight=92
    //% blockGap=20 
    //% color="#8FBC8F"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=StemLab_KeyBoard_Number block="KeyBoard sendNumber|%value"
    //% weight=91
    //% blockGap=20 
    //% color="#8FBC8F"
    ...
    //% blockId=StemLab_KeyBoard_Keys block="KeyBoard sendKeys|%key"
    //% weight=90
    //% blockGap=20 
    //% color="#8FBC8F"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
